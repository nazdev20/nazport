...
import { Home, User, Briefcase, FolderGit2, Mail, ArrowUp } from 'lucide-react';
    ...
    <>
      {showBackToTop && (
        <button
          ...
          title="Back to top"
          className="md:hidden fixed right-4 bottom-[calc(4.5rem+env(safe-area-inset-bottom))] z-40 flex size-10 items-center justify-center rounded-full border border-neutral-300 bg-white text-neutral-700 shadow-md transition-colors hover:bg-neutral-100 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800"
        >
